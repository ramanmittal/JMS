...
{
    public partial class pahse1001 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    JournalName = table.Column<string>(nullable: false),
                    JournalTitle = table.Column<string>(nullable: false),
                    JournalLogo = table.Column<string>(nullable: false),
                    JournalPath = table.Column<string>(nullable: false),
                    IsDisabled = table.Column<bool>(nullable: true),
                    Publisher = table.Column<string>(nullable: true),
                    OnlineISSN = table.Column<string>(nullable: true),
                    PrintISSN = table.Column<string>(nullable: true),
                    FirstLine = table.Column<string>(nullable: true),
                    LastLine = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JournalSettings", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JournalSettings_TenantId_Key",
                table: "JournalSettings",
                columns: new[] { "TenantId", "Key" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Tenants_JournalPath",
                table: "Tenants",
                column: "JournalPath",
                unique: true);
