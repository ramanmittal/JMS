...
namespace JMS.Entity.Migrations
{
    ...
    [Migration("20200831173400_RejectComment")]
    partial class RejectComment
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JMS.Entity.Entities.ReviewRequest", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("JMS.Entity.Entities.SubmissionHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("TenanatID")
                        .HasColumnType("bigint");

                    b.HasKey("Id");

                    b.HasIndex("TenanatID");
            ...
            modelBuilder.Entity("JMS.Entity.Entities.ReviewRequest", b =>
                {
                    b.HasOne("JMS.Entity.Entities.ApplicationUser", "Reviewer")
                        .WithMany()
            ...
            modelBuilder.Entity("JMS.Entity.Entities.Submission", b =>
                {
                    b.HasOne("JMS.Entity.Entities.ApplicationUser", "Editor")
                        .WithMany()
